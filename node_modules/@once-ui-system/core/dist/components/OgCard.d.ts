...
declare const OgCard: {
    ({ url, ogData: providedOgData, direction, sizes, unoptimized, size, serviceConfig, title, description, favicon, image, cardUrl, ...card }: OgCardProps): import("react/jsx-runtime").JSX.Element | null;
    displayName: string;
};
export { OgCard };
